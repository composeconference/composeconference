---
layout: 2018-melbourne/speaker
title: "Compose :: Melbourne Speaker - Julie Moronuki"
---

{% for t in site.data.2018-melbourne.speakers.times %}
{% unless t.hide %}
{% if t.name contains "Julie Moronuki" %}
...
<!--
        <p style="font-weight: bold;">
          ...
          If you want to see the whole lineup <a href="/2018-melbourne/day-one-program/">look here!</a>
        </p>
-->
